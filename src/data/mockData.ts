...
Prefer an exchange? Select "Exchange" in the Returns Portal and we'll ship your new item as soon as we receive the return.`,
    ...
    impactData: [
      { week: 'Mar 3', csat: 3.4, deflection: 62 },
      { week: 'Mar 10', csat: 3.3, deflection: 61 },
      { week: 'Mar 17', csat: 3.2, deflection: 60 },
      { week: 'Mar 24', csat: 3.3, deflection: 61 },
      { week: 'Mar 31', csat: 3.2, deflection: 59 },
      { week: 'Apr 7', csat: 3.5, deflection: 65 },
      { week: 'Apr 14', csat: 3.7, deflection: 69 },
      { week: 'Apr 21', csat: 3.9, deflection: 72 },
    ],
    fixAppliedWeek: 4,
  },
  {
...
Please wait 24 hours — packages are sometimes marked delivered early. If it still hasn't arrived, [contact us](https://example.com/contact) and we'll file a carrier claim on your behalf.`,
    ...
    impactData: [
      { week: 'Mar 3', csat: 3.6, deflection: 65 },
      { week: 'Mar 10', csat: 3.5, deflection: 64 },
      { week: 'Mar 17', csat: 3.6, deflection: 65 },
      { week: 'Mar 24', csat: 3.5, deflection: 63 },
      { week: 'Mar 31', csat: 3.4, deflection: 64 },
      { week: 'Apr 7', csat: 3.7, deflection: 70 },
      { week: 'Apr 14', csat: 3.9, deflection: 74 },
      { week: 'Apr 21', csat: 4.1, deflection: 78 },
    ],
    fixAppliedWeek: 4,
  },
  {
...
For specific rate quotes or shipping to a country not listed above, please [contact us](https://example.com/contact).`,
    ...
    impactData: [
      { week: 'Mar 3', csat: 3.5, deflection: 58 },
      { week: 'Mar 10', csat: 3.4, deflection: 57 },
      { week: 'Mar 17', csat: 3.5, deflection: 57 },
      { week: 'Mar 24', csat: 3.3, deflection: 56 },
    ],
  },
  {
    id: 'issue-4',
...
If your code should work but isn't, [contact us](https://example.com/contact) and we'll apply it manually.`,
    ...
    impactData: [
      { week: 'Mar 10', csat: 3.6, deflection: 61 },
      { week: 'Mar 17', csat: 3.5, deflection: 60 },
      { week: 'Mar 24', csat: 3.6, deflection: 60 },
      { week: 'Mar 31', csat: 3.4, deflection: 59 },
    ],
  },
  {
    id: 'issue-5',
...
If you've already placed an order and want to add a gift note or gift receipt, [contact us](https://example.com/contact) within 1 hour of placing your order and we'll do our best to accommodate.`,
    ...
    impactData: [
      { week: 'Mar 17', csat: 3.7, deflection: 64 },
      { week: 'Mar 24', csat: 3.6, deflection: 63 },
      { week: 'Mar 31', csat: 3.7, deflection: 63 },
    ],
  },
];
