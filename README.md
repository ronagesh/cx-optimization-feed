...
A prototype of a customer-facing optimization product for AI support teams. Built for customer ops and support leads at e-commerce companies running trials of AI customer support products, it surfaces the highest-priority issues degrading CSAT and deflection, explains why each issue matters in plain language, suggests a knowledge base fix the user can preview and edit, and tracks the before/after impact of every deployed fix using a 7-day rolling average. The goal: compress the cycle time from issue detection to measurable improvement.
