# Decagon Optimization Feed

A prototype for Decagon's customer-facing AI support optimization product. Built for an interview.

## What it does

Customer ops/support leads at e-commerce companies using Decagon's AI agent can use this tool to:

1. **View a prioritized feed of issues** — the system surfaces where the AI is underperforming, ranked by frequency, CSAT drag, deflection drag, business impact, and model confidence
